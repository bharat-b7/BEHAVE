...
class SMPLH_Layer(Module):
    ...
    def __init__(self,
                 center_idx=None,
                 gender='neutral',
                 model_root='/BS/bharat/work/installation/smplpytorch/smpl/native/models',
                 num_betas=300,
                 hands=False):
        """
        Args:
        ...
        self.hands = hands
        if gender == 'neutral':
            self.model_path = os.path.join('/BS/RVH/work/data/smpl_models/neutral', 'basicModel_neutral_lbs_10_207_0_v1.0.0.pkl')
        elif gender == 'female':
            ...
            if self.hands:
                self.model_path = os.path.join('/BS/XZ_project2/work/mano_v1_2/models/SMPLH_male.pkl')
            else:
                self.model_path = os.path.join(model_root, 'male_model.pkl')
